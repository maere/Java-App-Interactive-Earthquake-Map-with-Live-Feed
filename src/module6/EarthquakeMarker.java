...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public int compareTo(EarthquakeMarker o){
		...
		float fValOfCompared = o.getMagnitude();
		float fValOfThis = this.getMagnitude();
		
		Float fCaller = new Float(fValOfThis);
		Float fCalled = new Float(fValOfCompared);		
		
		return (-(fCaller.compareTo(fCalled)));
	}
